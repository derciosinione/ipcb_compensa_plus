...
export const useMarkNotificationReadMutation = () => {
  ...
  return useMutation({
    ...
    onMutate: async (id) => {
      ...
      queryClient.setQueryData<NotificationDto[]>(notificationQueryKeys.list(), (current = []) =>
    ...
    onError: (_error, _id, context) => {
      if (context?.previousNotifications) {
        queryClient.setQueryData(notificationQueryKeys.list(), context.previousNotifications);
      }
    },
    onSettled: () => {
