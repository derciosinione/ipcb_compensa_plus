...
import { mapSessionToUser, mapVerifyResponseToSession, saveAuthSession } from '../../services/auth/authSession';
...
export const VerifyMagicLinkPage = ({ onAuthenticated }: VerifyMagicLinkPageProps) => {
