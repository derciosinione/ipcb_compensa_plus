              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <Badge
                      variant="outline"
                      className={cn("mt-1 text-[10px]", h.color)}
                    >
                      {h.type}
                    </Badge>
                  </div>
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-slate-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 opacity-0 group-hover:opacity-100 transition-all"
                >
