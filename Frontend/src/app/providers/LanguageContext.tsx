...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'auth.enter_email': 'Enter your email address and we\'ll send you a login link.',
    'auth.email_sent': 'We\'ve sent a magic link to {email}. Click the link to sign in.',
    ...
    'courses.subtitle_coordinator': 'Manage the courses and curricula under your responsibility.',
    'courses.subtitle_teacher': 'Access the curricular units and classes you are teaching.',
    ...
    'courses.no_assigned_desc': 'You don\'t have any courses assigned to your profile yet. Please contact the administrator.',
    ...
    'details.date_approaching_desc': 'The requested date ({date}) is very close. Please review this request urgently.',
    ...
    'details.room_conflict_desc': 'Room {room} is already booked for another class at this time. Please review the schedule or discuss with the coordinator.',
    ...
    'form.fill_required': 'Please fill in all required fields (Course, Unit, Groups, Dates)',
    ...
    'sheet.description': 'Submit a request to reschedule a class or book an extra session.',
    ...
    'modal.add_course_desc': 'Create a new degree program to manage in the system.',
    ...
    'reject.desc': 'Please provide a reason for rejecting this request. This will be visible to the teacher.',
    ...
    'chart.description': 'Monthly breakdown of compensation requests and approvals.',
  ...
  pt: {
    ...
    'auth.email_sent': 'Enviamos um link mágico para {email}. Clique no link para entrar.',
    ...
    'courses.subtitle_admin': 'Gerencie todas as disciplinas e currículos do sistema.',
    'courses.subtitle_coordinator': 'Gerencie as disciplinas e currículos sob sua responsabilidade.',
    'courses.subtitle_teacher': 'Acesse as unidades curriculares e turmas que você está lecionando.',
    ...
    'courses.no_assigned_desc': 'Você não tem disciplinas atribuídas ao seu perfil. Entre em contato com o administrador.',
    ...
    'requests.subtitle': 'Gerencie e acompanhe suas solicitações de aulas substitutas.',
    ...
    'details.date_approaching_desc': 'A data solicitada ({date}) está muito próxima. Por favor, revise esta solicitação com urgência.',
    ...
    'details.room_conflict_desc': 'A sala {room} já está reservada para outra aula neste horário. Por favor, revise o horário ou discuta com o coordenador.',
    ...
    'form.fill_required': 'Por favor, preencha todos os campos obrigatórios (Curso, Unidade, Grupos, Datas)',
    ...
    'sheet.description': 'Envie uma solicitação para reagendar uma aula ou reservar uma sessão extra.',
    ...
    'modal.add_course_desc': 'Crie um novo programa de graduação para gerenciar no sistema.',
    ...
    'coordinator.admin_error': 'Administradores não podem alterar o status da solicitação.',
    ...
    'reject.desc': 'Por favor, forneça um motivo para rejeitar esta solicitação. Isso será visível para o professor.',
    ...
    'chart.description': 'Detalhamento mensal das solicitações e aprovações de compensação.',
